    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const hasPaymentThisMonth = paymentsSnapshot.docs.some(payDoc => {
          const paidAt = payDoc.data().paidAt?.toDate();
          return paidAt && 
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <button
            ...
            className="bg-purple-500 hover:bg-purple-600 text-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all"
          >
            <div className="text-4xl mb-2">📄</div>
          ...
          <button
            ...
            className="bg-orange-500 hover:bg-orange-600 text-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all relative"
          >
            {maintenanceCount > 0 && (
